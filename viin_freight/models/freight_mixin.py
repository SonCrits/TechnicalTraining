    ...
    def _compute_volume_uom_name(self):
        ...
        for record in self:
            if product_length_in_feet_param == '1':
                record.volume_uom_name = self.env.ref('viin_freight.product_uom_cbf').display_name
            else:
                record.volume_uom_name = self.env.ref('viin_freight.product_uom_cbm').display_name
