...
class ResPartner(models.Model):
    ...
    shipment_ids = fields.One2many('freight.shipment', 'customer_id', string='Shipments', groups="viin_freight.group_freight_user")
    ...
    def get_view(self, view_id=None, view_type='form', **options):
        ...
        if port_view and view_type == 'form':
            port_view_id = self.sudo().env.ref("viin_freight.freight_port_form").id
